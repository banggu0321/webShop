...
//DAO작업 완료 후 Service에 전달할 때 return은 1개만 가능.. 여러 값을 묶음(class로 정의하고 object를 만들어서 return)
public class EmpVO {
	// field(DBtable의 이름과 동일, type보면서 작성)
	...
	// getter/setter
	 ...
	 private Date hire_date; //SQL
	 private String job_id;
	 private double salary; //type이 number(8,2) 소수-> double
